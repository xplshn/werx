---
title: "Bands & Genres - WERX Full Demo"
date: 2025-12-02
authors:
  - name: "xplshn"
...
{{< prev URL="https://en.wikipedia.org/wiki/Pyotr_Ilyich_Tchaikovsky" TEXT="Tchaikovsky Wikipedia" >}}
...
{{< prev URL="https://en.wikipedia.org/wiki/Pink_Floyd" TEXT="Pink Floyd Wikipedia" >}}
{{< prev URL="https://en.wikipedia.org/wiki/Radiohead" TEXT="Radiohead Wikipedia" >}}
...
{{< prev URL="https://en.wikipedia.org/wiki/Led_Zeppelin" TEXT="Led Zeppelin Wikipedia" NO_IFRAME="true" >}}
...
{{< prev URL="https://en.wikipedia.org/wiki/Dave_Brubeck" TEXT="Dave Brubeck Wikipedia" >}}
...
{{< prev URL="https://es.wikipedia.org/wiki/Astor_Piazzolla" TEXT="Astor Piazzolla Wikipedia" >}}
...
graph TB
    ...
    Classical --> Jazz[Jazz]
    Classical --> TangoNuevo[Tango Nuevo]

    Blues[Blues/R&B] --> ClassicRock[Classic Rock]
    Blues --> Jazz

    ClassicRock --> ProgRock
    ClassicRock --> Alternative[Alternative/Indie]

    Jazz --> GypsyJazz[Gypsy Jazz]
    Jazz --> TangoNuevo

    Folk[Folk Traditions] --> FolkRock[Folk Rock]
    Folk --> LatinSong[Latin American Song]
    Folk --> ArgentineRock[Argentine Rock]

    Tango[Tango Tradition] --> TangoClasico[Tango Clásico]
    Tango --> TangoNuevo

    BigBand[Big Band/Swing] --> Jazz
    BigBand --> LightClassical[Light Classical]

    World[World/Balkan] --> ArgentineRock

    ProgRock --> ArgentineRock
    Alternative --> JapaneseRock[Japanese Rock]
